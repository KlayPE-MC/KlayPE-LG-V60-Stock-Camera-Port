...
| Video | 1080p30, 1080p60, 4K30, 4K60, 8K where exposed; verify files with ffprobe |
...
- For 1080p60 and 4K60, verify `avg_frame_rate` and frame count. UI labels are
  not proof of 60 fps. The tested APK requests a fixed 60/60 range.
- Continuous autofocus during 60 fps recording is still a known limitation;
  do not report the port as fully complete without testing near/far transitions.
